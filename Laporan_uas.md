...
![Distribusi Sentimen](data/asset/eda_distribusi_sentimen.png)
...
![Distribusi Panjang Komentar](data/asset/eda_panjang_komentar.png)
...
![Kata Populer](data/asset/eda_kata_populer.png)
...
![Perbandingan Kinerja Model](data/asset/perbandingan_kinerja_model.png)
...
![Confusion Matrix Naive Bayes](data/asset/confusion_matrix_naive_bayes.png)
...
![Confusion Matrix Linear SVM](data/asset/confusion_matrix_linear_svm.png)
...
1. [Dataset komentar mentah](data/dataset/1_komentar_raw.csv)
2. [Dataset hasil preprocessing](data/dataset/2_komentar_clean.csv)
3. [Dataset hasil pelabelan sentimen](data/dataset/3_komentar_labeled.csv)
4. [Dataset hasil EDA](data/dataset/4_dataset_hasil_eda.csv)
5. [Hasil perbandingan model](data/dataset/hasil_perbandingan_model.csv)
6. [Ringkasan distribusi sentimen](data/dataset/ringkasan_distribusi_sentimen.csv)
7. [Ringkasan kata populer](data/dataset/ringkasan_kata_populer.csv)
...
![Confusion Matrix Complement Naive Bayes](data/asset/confusion_matrix_naive_bayes.png)
